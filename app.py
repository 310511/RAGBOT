...
from llama_index import Document, VectorStoreIndex, ServiceContext, SimpleDirectoryReader
...
def build_index_from_chunks(text_chunks):
    embeddings = GoogleGenerativeAIEmbedding(model="models/embedding-001", google_api_key=gemini_api_key)
